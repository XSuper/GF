...
public class AbSlidingPlayView extends LinearLayout {
	...
	public void initView(Context context){
		...
		mPageLineLayoutParent.addView(pageLineLayout,new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,35));
		mPageLineLayoutParent.setBackgroundResource(R.color.halftransparent);
