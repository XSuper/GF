...
//        mResizeDrawableDiagonal2 = AbImageUtil.bitmapToDrawable(AbFileUtil.getBitmapFormSrc("image/crop_small.png"));
        ...
        mResizeDrawableDiagonal = AbImageUtil.bitmapToDrawable(BitmapFactory.decodeResource(mContext.getResources(),R.drawable.crop_big));
        mResizeDrawableDiagonal2 = AbImageUtil.bitmapToDrawable(BitmapFactory.decodeResource(mContext.getResources(),R.drawable.crop_small));
    }
