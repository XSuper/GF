 ...
 */
public class AbPullHorizontalView extends ScrollView{
	 ...
	 */
	public AbPullHorizontalView(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public AbPullHorizontalView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		LinearLayout.LayoutParams layoutParamsFF = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT,1);
		...
		hlistview = new HorizontalListView(context, null);
		hlistview.setLayoutParams(layoutParamsFF);
		hlistview.setBackgroundColor(Color.RED);
		mScrollLayout.addView(hlistview, layoutParamsFF);
