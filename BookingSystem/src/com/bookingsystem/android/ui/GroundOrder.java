...
public class GroundOrder extends MBaseActivity implements OnClickListener {
...
//		ViewUtil.bindView(time,JSONUtil.getString(jo, "playtime"));
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				net.addParam("playtime",MApplication.searchTime);
				net.addParam("playdate", MApplication.searchDate);
				...
				net.doGetInDialog(new NetTask(GroundOrder.this) {
					@Override
					public void doInUI(Response response, Integer transfer) {
						if (response.success) {
							String id = JSONUtil.getString(
									response.jSONFromData(), "orderid");
							Intent i = new Intent(GroundOrder.this,
