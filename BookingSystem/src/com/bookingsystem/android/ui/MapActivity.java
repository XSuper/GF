...
public class MapActivity extends MBaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// setTitle(titleLable);
		// 初始化地图
		stLon = (int)(MApplication.longitude*1E6);
		stLat =(int)(MApplication.latitude*1E6);
...
//		locData.latitude = MApplication.latitude;
//		locData.longitude = MApplication.longitude;
//		locData.direction = 2.0f;
//		myLocationOverlay.setData(locData);
//		
		Drawable mark= getResources().getDrawable(R.drawable.annotation4sx);  
		//用OverlayItem准备Overlay数据  
		OverlayItem item1 = new OverlayItem(enpoint,"item1","item1");
	...
	//弹窗弹出位置  
		...
		v.setBackgroundResource(R.drawable.map_bg);;
		v.setText(name);
		v.setTextColor(Color.WHITE);
		v.setTextSize(18);
		v.setPadding(30, 30, 30, 30);
	//弹出pop,隐藏pop  
		pop.showPopup(v, enpoint, 50);  
		mMapView.refresh();
		mMapView.getController().animateTo(enpoint);
	...
	void SearchButtonProcess(View v) {
		...
		if (mBtnDrive.equals(v)) {
			...
			mSearch.drivingSearch(StringUtils.placeToString(MApplication.city), stNode, place, enNode);
		} else if (mBtnTransit.equals(v)) {
			mSearch.transitSearch(StringUtils.placeToString(MApplication.city), stNode, enNode);
		} else if (mBtnWalk.equals(v)) {
			mSearch.walkingSearch(StringUtils.placeToString(MApplication.city), stNode, place, enNode);
		}
	}
