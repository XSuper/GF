...
public class LXCOrderDetail extends MBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setAbContentView(R.layout.activity_order_lxcdetail);
	...
	private void loadData() {
		...
		net.doGetInDialog(new NetTask(this) {
			...
			public void doInUI(Response response, Integer transfer) {
				...
				ViewUtil.bindView(danwei, JSONUtil.getString(jo, "priceunit"),"pricetype");
