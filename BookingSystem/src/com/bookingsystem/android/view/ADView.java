...
public class ADView extends LinearLayout {
	...
	public void initView(Context context){
		...
		mPageLineLayoutParent.setPadding(0,8, 0, 8);
		pageLineLayout = new LinearLayout(context);
		pageLineLayout.setPadding(15, 1, 15, 1);
		//pageLineLayout.setVisibility(View.INVISIBLE);
		mPageLineLayoutParent.addView(pageLineLayout,new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,40));
		mPageLineLayoutParent.setBackgroundResource(R.color.transparent);
		...
		displayImage = BitmapFactory.decodeResource(getResources(),R.drawable.g_icon2);
		hideImage = BitmapFactory.decodeResource(getResources(),R.drawable.g_icon1);
//		displayImage = AbFileUtil.getBitmapFormSrc("play_display.png");
//		hideImage = AbFileUtil.getBitmapFormSrc("play_hide.png");
	...
	/**
	 * 添加底部 不滑动view   滑动view 直接放在pager里面的view
	 * @param view
	 */
	public void addBottomNotChangeView(View view){
		if(view== null)return;
...
//        lp1.addRule(RelativeLayout.CENTER_VERTICAL,RelativeLayout.TRUE);
        ...
        mRelativeLayout.addView(view,lp1);
